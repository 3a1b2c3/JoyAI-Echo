        ...
        {hasMessages ? (
          <div className="mx-auto flex min-h-full w-full max-w-[64rem] flex-col">
            <div className="flex-1 px-4 pb-20 pt-4">
              <div className="mx-auto w-full max-w-[49.5rem]">
                ...
                />
                {actionSlot ? (
                  <div className="flex justify-end text-lg">{actionSlot}</div>
                ) : null}
              </div>
            </div>
          ...
          <div className="mx-auto flex min-h-full w-full max-w-[64rem] flex-col px-4">
            <div className="flex flex-1 items-center justify-center">
              <div className="w-full max-w-[40rem]">{emptyState}</div>
            </div>
            {!hideComposer ? (
              <div className="sticky bottom-0 z-10 w-full max-w-[40rem] self-center pb-4">
                {composer}
              </div>
            ) : null}
          </div>
