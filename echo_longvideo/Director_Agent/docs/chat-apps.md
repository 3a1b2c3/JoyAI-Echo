...
```bash
pip install echo-director-agent[matrix]
```
...
```bash
pip install "echo-director-agent[weixin]"
```
...
```bash
pip install echo-director-agent[wecom]
```
...
```bash
pip install echo-director-agent[msteams]
```
