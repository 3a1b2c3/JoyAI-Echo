...
def is_empty_final_response_message(content: str | None) -> bool:
    """True when *content* is the runner's empty-final placeholder."""
    if content is None:
        return False
    return content.strip() == EMPTY_FINAL_RESPONSE_MESSAGE
